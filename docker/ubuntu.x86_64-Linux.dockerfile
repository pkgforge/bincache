...
# Based on :: https://github.com/pkgforge/bincache/blob/main/docker/ubuntu-systemd-base.dockerfile
...
RUN <<EOS
 ...
 #Change to bash 
  ...
  #https://github.com/Azathothas/Arsenal/blob/main/misc/Linux/.bashrc
...
RUN <<EOS
 ...
 curl -qfsSL "https://raw.githubusercontent.com/pkgforge/devscripts/main/Linux/install_bins_curl.sh" -o "./tools.sh"
 dos2unix --quiet "./tools.sh" && chmod +x "./tools.sh"
 INSTALL_SRC="https://bin.pkgforge.dev/x86_64_Linux" bash "./tools.sh" 2>/dev/null || true ; rm -rf "./tools.sh"
EOS
#------------------------------------------------------------------------------------#
...
RUN <<EOS
  ...
  #https://github.com/Azathothas/Arsenal/blob/main/misc/Linux/sshd_config_passwordless
  curl -qfsSL "https://pub.ajam.dev/repos/Azathothas/Arsenal/misc/Linux/sshd_config_passwordless" -o "/etc/ssh/sshd_config"
  #Perms
